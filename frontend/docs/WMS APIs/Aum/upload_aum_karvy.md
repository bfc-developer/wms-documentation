# Upload AUM KARVY
Uploads AUM (Assets Under Management) data for KARVY RTA by clearing existing dump data, inserting new Excel data, calculating AUM from the dump, updating AMC-wise AUM totals, and updating AMC short names.
...
flowchart TD
    ...
    InsertData --> CalcAUM[Execute calculateaumkarvydump Function]
    
    CalcAUM --> UpdateAMC[Execute updateamcwiseaum for KARVY]
